...
<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-edit-3"></i> <?php echo lan("cookie_policy_page"); ?></h3>
  </div>
  <?php echo form_open($form_url, $form_attributes); ?>
    <div class="card-body">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          <h5 class="text-info"><i class="fe fe-link"></i> <?=lan("Status")?></h5>
          ...
          <h5 class="text-info"><i class="fe fe-link"></i> <?php echo lan("Content"); ?></h5 class="text-info">
          <div class="form-group">
