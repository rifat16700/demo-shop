<?php
  ...
  $form_attributes = array('class' => 'form actionForm row','method' => "POST");
...
<div class="">
  <div class="card-header">
    <h3 class="card-title"><?= show_item_transaction_type($tab) ?> <?=lang("City Bank Setup for-".$brand->brand_name)?></h3>
  </div>
  <div class="">
    <div class="">
