...
<head>
    ...
    <style>
        ...
        .status-icon-ring {
            ...
            margin: 0 auto 16px;
            animation: scale-bounce 0.6s ease forwards;
        }
        .status-icon-inner {
            width: 72px;
            height: 72px;
        ...
        .checkmark-path {
            ...
            animation: checkmark-draw 0.5s ease 0.4s forwards;
        }
            ...
            <div class="report-content">
                ...
                <div class="status-icon-ring">
                    <div class="status-icon-inner">
                        <svg viewBox="0 0 24 24" fill="none">
                            <path class="checkmark-path" d="M5 13l4 4L19 7" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                </div>
                ...
                <div class="details-card">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value"><?= ucwords($temp_method) ?></span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Transaction ID</span>
                        <span class="detail-value"><?= $temp_transaction_id ?></span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Amount</span>
                        <span class="detail-value amount"><?= currency_format($temp_amount) ?></span>
                    </div>
                    <?php if (!empty($fees_amount) && $fees_amount > 0): ?>
                    <div class="detail-row">
                        <span class="detail-label">Fee</span>
                        <span class="detail-value"><?= currency_format($fees_amount) ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="detail-row">
                        <span class="detail-label">Status</span>
                        <span class="detail-value status-title"><?= strtoupper($status) ?></span>
                    </div>
                </div>
                ...
                <div class="countdown-bar">
                    <p class="countdown-text">
                        <span class="countdown-num" id="redirect_countdown">5</span> সেকেন্ডে রিডাইরেক্ট হবে
                    </p>
                    <div class="progress-track">
                        <div class="progress-fill" id="progressFill" style="width: 100%; background: linear-gradient(90deg, var(--bg1), var(--bg2));"></div>
                    </div>
                </div>

                <!-- Support Note -->
                <div class="support-section">
                    <p>Powered by <a href="<?= BASE_SITE ?>"><?= get_option('site_name', 'Ekhoni Digital') ?></a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var downloadTimer = setInterval(function() {
            ...
            if (timeleft <= 0) {
                ...
                document.getElementById('redirect_countdown').innerHTML = '0';
        ...
        (function() {
            ...
            var colors = ['#34d399', '#6366f1', '#fbbf24', '#f87171', '#a78bfa', '#38bdf8'];
            for (var i = 0; i < 30; i++) {
