    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        body{
            ...
            background:linear-gradient(160deg,#e3f0fc 0%,#d6e8f7 50%,#e8f1fc 100%);
            min-height:100vh;
            display:flex;
            align-items:center;
        ...
        .zp-wrap{
            background:#fff;
            border-radius:18px;
            box-shadow:0 8px 40px rgba(0,87,208,.08);
            max-width:540px;
            width:100%;
        ...
        .zp-top{
            ...
            padding:12px 16px;border:1px solid rgba(0,87,208,.07);
            margin-bottom:22px;
        }
        .zp-top a,.zp-top button{
            color:#6d7f9a;background:none;border:none;
        ...
        .zp-brand-img{
            ...
            box-shadow:0 2px 10px rgba(0,87,208,0.08);
        }
        .zp-brand-img img{width:100%;height:100%;object-fit:contain;padding:4px;border-radius:50%;}
        .zp-brand h2{font-size:18px;font-weight:700;color:#1e293b;margin-bottom:6px;}
        .zp-vd{
            display:inline-block;padding:4px 16px;
            border:1.5px solid #0c87c9;border-radius:20px;
            color:#0c87c9;font-size:12px;font-weight:600;
            text-decoration:none;cursor:pointer;transition:.2s;
        }
        .zp-vd:hover{background:#0c87c9;color:#fff;}
        /* ── Support icons ── */
        ...
        .zp-si:hover{border-color:#0c87c9;background:#f0f7ff;}
        .zp-si svg{width:20px;height:20px;}
        /* ── Tabs ── */
        .zp-tabs{
            display:flex;background:#0c87c9;border-radius:25px;
        ...
        .zp-tb.active{background:rgba(255,255,255,.22);color:#fff;}
        /* ── Gateway grid ── */
        .zp-grid{
            display:none;
        ...
        .zp-gc{
            background:#fff;border:1.5px solid #f0f4f8;border-radius:12px;
        ...
        .zp-gc:hover{
            border-color:#0c87c9;
            box-shadow:0 6px 20px rgba(12,135,201,.12);
            transform:translateY(-2px);
        }
        .zp-gc img{max-width:90%;max-height:42px;object-fit:contain;}
        /* ── Pay bar ── */
        .zp-pay{
            background:#d4eaf8;border-radius:25px;
            padding:14px;text-align:center;
            color:#0c87c9;font-size:16px;font-weight:700;
        }
        /* ── Modal overlay ── */
        .zp-ov{
        ...
        .zp-mx{
            ...
            cursor:pointer;color:#64748b;font-size:16px;transition:.2s;
        }
        .zp-mx:hover{background:#f1f5f9;}
        .zp-modal h3{font-size:18px;font-weight:700;color:#1e293b;margin-bottom:6px;}
        .zp-modal p.desc{font-size:13px;color:#64748b;line-height:1.6;margin-bottom:18px;}
        /* ── Method option ── */
        .zp-mo{
            display:flex;align-items:center;
            padding:14px 16px;background:#f8fbff;
            border:1.5px solid #f0f4f8;border-radius:12px;
            margin-bottom:10px;cursor:pointer;transition:.2s;
            text-decoration:none;
        }
        .zp-mo:hover{border-color:#0c87c9;background:#eef6ff;}
        ...
        .zp-ml{font-size:15px;font-weight:600;color:#1e293b;}
        ...
        .zp-tl li{display:flex;justify-content:space-between;padding:9px 0;font-size:14px;color:#6d7f9a;}
        .zp-tl li:last-child{font-weight:600;color:#0c87c9;}
        .zp-tl hr{border:none;border-top:1px solid #f0f4f8;margin:0;}
        /* ── Loader ── */
        .zp-loader{
            display:none;position:fixed;top:0;left:0;right:0;bottom:0;
            background:rgba(255,255,255,.85);z-index:200;
            align-items:center;justify-content:center;
        }
        .zp-spin{
            width:42px;height:42px;
            border:4px solid #e2e8f0;border-top-color:#0c87c9;
...
<body>
    ...
    <div class="zp-wrap">
        ...
        <div class="zp-top">
            <a href="<?= BASE_SITE; ?>">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6d7f9a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 12H5"/><path d="M12 19l-7-7 7-7"/></svg>
            </a>
            <button class="cancel_btn" data-url="<?= base_url('api/checkout/undetected/' . $all_info['tmp_ids'] . '/' . encodeParams('0')) ?>">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6d7f9a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            </button>
        </div>
        ...
        <div class="zp-sup">
            <a href="#" class="zp-si" id="supportBtn" title="Support">
                <svg viewBox="0 0 24 24" fill="none" stroke="#0c87c9" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 18v-6a9 9 0 0118 0v6"/><path d="M21 19a2 2 0 01-2 2h-1a2 2 0 01-2-2v-3a2 2 0 012-2h3zM3 19a2 2 0 002 2h1a2 2 0 002-2v-3a2 2 0 00-2-2H3z"/></svg>
            </a>
            ...
            <a href="tel:<?= $all_info['mobile_number'] ?>" class="zp-si" title="Call">
                <svg viewBox="0 0 24 24" fill="none" stroke="#0c87c9" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
            </a>
        </div>
        ...
        // Group gateways by g_type
        $grouped_mobile = [];
        if (!empty($mobile_s)) {
            foreach ($mobile_s as $mb) {
                $grouped_mobile[$mb->g_type][] = $mb;
            }
        }
        $grouped_bank = [];
        if (!empty($bank_s)) {
            foreach ($bank_s as $mb) {
                $grouped_bank[$mb->g_type][] = $mb;
            }
        }
        $grouped_int = [];
        if (!empty($int_b_s)) {
            foreach ($int_b_s as $mb) {
                $grouped_int[$mb->g_type][] = $mb;
            }
        }
        ?>
            ...
            <div id="tab_mobile" class="zp-grid">
                <?php foreach ($grouped_mobile as $gtype => $methods) :
                    ...
                    foreach ($methods as $m) {
                        $mj[] = [
                            'label' => $method_labels[$m->active_payment] ?? ucfirst($m->active_payment),
                            'type'  => $m->active_payment,
                            'url'   => base_url('api/execute_payment/' . $m->g_type . '/' . $all_info['tmp_ids'] . '?acc_tp=' . encrypt($m->active_payment)),
                        ];
                    }
                ?>
            ...
            <div id="tab_bank" class="zp-grid">
                <?php foreach ($grouped_bank as $gtype => $methods) :
                    ...
                    foreach ($methods as $m) {
                        $mj[] = [
                            'label' => 'Bank Transfer',
                            'type'  => $m->active_payment ?? 'bank',
                            'url'   => base_url('api/execute_payment/' . $m->g_type . '/' . $all_info['tmp_ids']),
                        ];
                    }
                ?>
                    <div class="zp-gc" data-gtype="<?= $gtype ?>" data-methods='<?= json_encode($mj) ?>'>
        ...
        if (!empty($grouped_int)) { ?>
            <div id="tab_int" class="zp-grid">
                <?php foreach ($grouped_int as $gtype => $methods) :
                    ...
                    foreach ($methods as $m) {
                        $mj[] = [
                            'label' => ($m->active_payment == 'live' ? 'Crypto' : ($method_labels[$m->active_payment] ?? ucfirst($m->active_payment))),
                            'type'  => $m->active_payment,
                            'url'   => base_url('api/execute_payment/' . $m->g_type . '/' . $all_info['tmp_ids'] . '?acc_tp=' . encrypt($m->active_payment)),
                        ];
                    }
    ...
    <div class="zp-ov" id="detailsModal">
        <div class="zp-modal">
            ...
            <ul class="zp-tl" style="margin-top:16px;">
                <li><span>Invoice To:</span><span><?= ucfirst($all_info['brand_name']) ?></span></li>
                <hr>
                <li><span>Trx Id:</span><span><?= $all_info['transaction_id'] ?></span></li>
                <hr>
                <li><span>Amount:</span><span><?= currency_format($all_info['amount']) ?></span></li>
                <hr>
    ...
    <div class="zp-ov" id="supportModal">
        <div class="zp-modal">
            ...
            <a href="tel:<?= $all_info['mobile_number'] ?>" class="zp-mo">
                <svg viewBox="0 0 24 24" fill="none" stroke="#0c87c9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="28" height="28"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
            ...
            <a href="mailto:<?= $all_info['support_mail'] ?>" class="zp-mo">
                <svg viewBox="0 0 24 24" fill="none" stroke="#0c87c9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="28" height="28"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
    ...
    $(function(){
        ...
        // ── Gateway click → modal or navigate ──
        $(".zp-gc").click(function(){
            ...
            if(methods.length===1){
                ...
                window.location.href=methods[0].url;
            } else {
                var h='';
                methods.forEach(function(m){
                    h+='<a href="'+m.url+'" class="zp-mo gw-link">';
                    h+='<img src="'+img+'">';
                    h+='<div><div class="zp-ml">'+m.label+'</div>';
                    h+='<div class="zp-ms">'+gtype.charAt(0).toUpperCase()+gtype.slice(1)+'</div>';
                    h+='</div></a>';
                });
                $("#methodList").html(h);
                $("#methodModal").addClass("show");
            }
        });
