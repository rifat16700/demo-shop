                ...
                <table role="presentation" width="520" cellspacing="0" cellpadding="0" style="background:linear-gradient(135deg,#1e1b4b,#1e293b);border-radius:16px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.4);">
                    ...
                    <tr>
                        <td style="padding:25px 30px 10px;">
                            ...
                            <p style="color:#94a3b8;font-size:13px;margin:0;line-height:1.6;">Thank you for your purchase! Your payment has been verified and your product is ready.</p>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr><td style="color:#94a3b8;font-size:12px;padding-bottom:8px;">Product</td><td align="right" style="color:#e2e8f0;font-size:13px;font-weight:600;padding-bottom:8px;"><?= esc($product_name) ?></td></tr>
                                            <tr><td colspan="2" style="border-bottom:1px solid rgba(255,255,255,0.06);padding-bottom:8px;"></td></tr>
                                            <tr><td style="color:#94a3b8;font-size:12px;padding-top:8px;padding-bottom:8px;">Amount Paid</td><td align="right" style="color:#34d399;font-size:16px;font-weight:700;padding-top:8px;padding-bottom:8px;">৳<?= number_format($amount, 2) ?></td></tr>
                                            <tr><td colspan="2" style="border-bottom:1px solid rgba(255,255,255,0.06);padding-bottom:8px;"></td></tr>
                                            <tr><td style="color:#94a3b8;font-size:12px;padding-top:8px;padding-bottom:8px;">Payment Method</td><td align="right" style="color:#e2e8f0;font-size:13px;font-weight:500;padding-top:8px;padding-bottom:8px;"><?= ucwords($method) ?></td></tr>
                                            <tr><td colspan="2" style="border-bottom:1px solid rgba(255,255,255,0.06);padding-bottom:8px;"></td></tr>
                                            <tr><td style="color:#94a3b8;font-size:12px;padding-top:8px;">Transaction ID</td><td align="right" style="color:#a78bfa;font-size:12px;font-weight:600;padding-top:8px;"><?= esc($transaction_id) ?></td></tr>
                                        </table>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding:10px 30px 20px;text-align:center;">
                            ...
                            <a href="<?= esc($delivery_link) ?>" style="display:inline-block;padding:16px 40px;background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#ffffff;font-size:16px;font-weight:700;text-decoration:none;border-radius:12px;letter-spacing:0.5px;">📥 Download Now</a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:20px 30px;border-top:1px solid rgba(255,255,255,0.06);text-align:center;">
                            <p style="color:rgba(255,255,255,0.25);font-size:11px;margin:0 0 4px;">This is an automated email from <strong><?= esc($brand_name) ?></strong></p>
                            <p style="color:rgba(255,255,255,0.15);font-size:10px;margin:0;">Powered by <?= get_option('site_name', 'Ekhoni Digital') ?></p>
                        </td>
                    </tr>
                </table>
            </td>
